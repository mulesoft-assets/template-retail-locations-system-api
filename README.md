# Template Retail Locations System API
...
This API is part of Retail Catalyst and serves to get information about physical store locations with possibility of search based on geographical coordinates. It allows to check the available items in stores and also make reservations.
...
# Run it! <a name="runit"/>
Simple steps to get Retail Locations System API running.
See below.
